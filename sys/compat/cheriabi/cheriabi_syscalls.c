...
const char *cheriabi_syscallnames[] = {
	...
	"cheriabi_caprevoke_shadow",			/* 259 = cheriabi_caprevoke_shadow */
	"cheriabi_caprevoke",			/* 260 = cheriabi_caprevoke */
	"cheriabi_caprevoke_entire_shadow_cap",			/* 261 = cheriabi_caprevoke_entire_shadow_cap */
	"#262",			/* 262 = nosys */
	"#263",			/* 263 = nosys */
	"#264",			/* 264 = nosys */
	"#265",			/* 265 = nosys */
